...
> 包含契約整理、Apple UI、D-022、工安清單／詳情殼，以及全案程式與文件整理；驗證見 [BASELINE](docs/BASELINE.md)。前端已由 main 自動部署；DB 已同步至 `20260917213500`、Edge 最後重佈 2026-09-17（全部 18 支），版本與核對範圍見 §6.3。

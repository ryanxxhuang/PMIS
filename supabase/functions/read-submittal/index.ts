    ...
    findings: {
      ...
      items: {
        ...
        properties: {
          ...
          status: { type: 'string', enum: ['符合', '部分符合', '不符', '未涵蓋', '需人工確認', '不適用'], description: '依文件實際內容判定。文件未提及但屬本送審應涵蓋=未涵蓋;此需求本不屬本送審類別應涵蓋=不適用(如施工計畫不需載明逾期罰款/月報/竣工文件期限);涉及具體數值/尺寸須人工複核=需人工確認。' },
...
const SYS =
  ...
  '絕不捏造文件中沒有的內容。**範圍判定**:提供的是全案履約需求,並非每項都屬「本次送審類別」應涵蓋——與本送審類別無關者(如施工計畫不需載明逾期罰款/月報/竣工文件期限)標「不適用」,' +

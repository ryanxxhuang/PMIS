-- P0 恢復批4(P0-06):自 ba8a5ec 原樣取回(supabase/migrations/20260710000500),重新編號部署。
-- 修改(相對原版):guard_ingestion_run_write 注入「專案刪除 cascade 放行」——
--   原版 before delete 會擋含 ingestion runs 的專案整案刪除(P0 事故型;hotfix 000700 教訓,
--   改用已驗證的 parent-row-gone 模式而非 GUC)。

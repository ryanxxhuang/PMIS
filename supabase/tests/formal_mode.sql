...
-- 狀態用合法值「審核中」:D-016 順序 gate 要求機關核准必從審核中,
-- 舊字串「送審」不在狀態集合(提出/審核中/核准/駁回)裡,是 fixture 筆誤。
insert into public.change_orders (id, project_id, co_no, title, status) values
  ('33000000-0000-0000-0000-000000000041','23000000-0000-0000-0000-000000000001', 'CO-T01', '追加工項', '審核中');

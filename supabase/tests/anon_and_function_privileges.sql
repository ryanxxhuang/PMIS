...
-- ── 3. authenticated 允許清單精確相等（83 支：68 支來源與理由見 migration 檔頭＋P5c update_project_anchors＋P4b 20260919140000 十支估驗 RPC＋P3c create_inspection_form_draft＋P3e set_intake_shared_input／list_intake_shared_inputs＋P5e get_project_warranty）─
select is(

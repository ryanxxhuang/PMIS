...
落地：token、圖示、字級、球權側欄、收件匣與契約／工安共用清單詳情殼已實作並隨 PR #64 的前端部署上線；其他頁面的殼、原文高亮與行銷站整合仍待續接，不能當成全產品已完成；登入頁（登入／註冊／忘記密碼／demo 入口）已於 2026-09-11 依規範 §2～§6 套用 Apple style，流程與 Supabase 呼叫不變。

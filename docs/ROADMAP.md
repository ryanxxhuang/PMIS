...
- ~~循環義務目前只算下次日期；逐期資料、月末／跨年／29～31 日、基準日更正與準時率需產品決策＋migration／pgTAP。~~ P5b（逐期、月末／跨年）與 P5c（基準日版本、重算只動未完成、停止條件）已落地。仍缺：保固類循環義務的保固期滿日沒有欄位可判定（目前不自動產生、列停止條件待補）；逐期準時率的完整呈現（P5d）。

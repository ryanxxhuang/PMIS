...
> 狀態：**ACTIVE（W0–W8 全數完成；W8-1 PR #11、W8-2 PR #12、W8-3A PR #13、W8-1R PR #14、W8-3B PR #15、W8-4A PR #16、W8-4B PR #18、W8-4C PR #17、W8-5 PR #19、W6-4 收官 PR #20、W8-6 真人驗收修正包 PR #21、W8-7 照片先行與查驗縫合 PR #22；已核准清單全數交付）**
> 最後更新：2026-08-19（W8-7：照片先行 AI 日誌＋白板區域結構化＋查驗↔自主檢查表縫合合併部署；migrations `20260819120000`/`20260819120100` 已套用正式庫、classify-site-photo 已重新部署；詳見 CURRENT.md §6）

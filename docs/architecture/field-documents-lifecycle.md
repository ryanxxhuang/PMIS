...
| `create_field_document_draft`（service；P2b 起稿改由 Edge service 直接 INSERT，本 RPC 未建）、`set_intake_shared_input`、`discard_field_document` | security definer RPC | P3e |

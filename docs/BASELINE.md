...
- 真後端 `npm run test:e2e:real -- chain7 chain2`（本機共用 stack 套用本支；rollback 檔實跑回復再重套；埠 5189）：chain 7 4.5s、chain 2 12.8s 通過（rebase 後於 worktree 4 重跑）。

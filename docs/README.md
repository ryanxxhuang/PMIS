...
> 2026-09-11 精簡。先讀必要入口，其餘按任務開啟；不要一次載入所有文件。

| 用途 | 文件 |
|---|---|
| 開發規則／現況 | [DEVELOPMENT](../DEVELOPMENT.md)、[CURRENT](../CURRENT.md) |
| 已定案約束／續接候選 | [DECISIONS](DECISIONS.md)、[ROADMAP](ROADMAP.md) |
| 實作機制 | [架構索引](architecture/README.md) |

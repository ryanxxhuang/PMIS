...
目前產品整理評估見 [`產品全案評估報告-2026-08-12.md`](產品全案評估報告-2026-08-12.md)；全產品 UI/UX 第二版重新評估、36 路由處置與已核准 W8 分階段計畫見 [`W8-0-UIUX-全產品評估與改版藍圖-2026-08-13.md`](W8-0-UIUX-全產品評估與改版藍圖-2026-08-13.md)。W8-1 已完成並提交 PR #11、尚未合併／部署；後續工作以 `ROADMAP.md` 的第一個未完成 W8 工作包為準。Requirement／obligation 的決策與正式庫匿名基線見 [`W5-1-Requirement-Obligation-決策書.md`](W5-1-Requirement-Obligation-決策書.md)；已實作現況以 `CURRENT.md` 為準。

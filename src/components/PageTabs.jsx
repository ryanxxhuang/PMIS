...
// 兩處字面值刻意對齊,改一邊另一邊要跟。
export const CHIP_BASE = 'h-8 max-md:min-h-11 max-md:min-w-11 shrink-0 inline-flex items-center justify-center px-3.5 rounded-lg text-body font-medium whitespace-nowrap pressable'

    ...
    <div className="min-h-screen bg-slate-100 print:bg-white">
      ...
      <div className="max-w-[820px] mx-auto bg-white my-6 print:my-0 p-10 print:p-0 shadow-sm print:shadow-none text-body text-slate-800">
        <div className="text-center mb-5">
          ...
          <div className="mt-2 inline-block text-footnote text-amber-700 border border-amber-300 rounded px-3 py-1.5">
        ...
        <div className="mb-5">
          ...
          <textarea
            ...
            rows={4}
            className="w-full text-body leading-relaxed text-slate-800 border border-slate-200 print:border-0 rounded p-2 print:p-0 resize-none focus:outline-none focus:border-[var(--blue)]"
          />
        </div>
        ...
        {!loaded ? (
          <div className="text-slate-500 text-footnote py-4">照片載入中…</div>
        ) : inclCount === 0 ? (
          <div className="text-slate-600 text-footnote py-4 border border-dashed border-slate-200 rounded px-3 print:border-0">
            {photoCount === 0
          ...
          <div className="space-y-4">
            {leaves.filter((it) => incl(photosByItem[it.item_key]).length).map((it) => (
              <div key={it.item_key} className="break-inside-avoid">
                <div className="text-footnote font-medium text-slate-700 mb-1">
                  ...
                  {incl(photosByItem[it.item_key]).map((p) => {
                    ...
                    return (
                      <figure key={p.id} className="relative border border-slate-200 rounded overflow-hidden break-inside-avoid group">
                        ...
                        <figcaption className="text-micro text-slate-500 px-1.5 py-1 leading-tight">
        ...
        <label className="print:hidden flex items-center gap-2 mt-8 text-footnote text-slate-600 select-none cursor-pointer max-md:min-h-11">
        ...
        <div className="text-caption text-slate-500 mt-3 print:hidden">
          保留款 {retPct}%。
        </div>
      </div>
    </div>

...
import { routeAllowed, routeRegistry, defaultLandingPath, landingLabel } from './lib/navConfig.js'
...
const RequirementsReview = lazy(() => import('./pages/web/RequirementsReview.jsx'))
...
function NotFound() {
  ...
  return (
    <div className="text-center py-20 space-y-3">
      ...
      <Link to={defaultLandingPath(currentUser?.org_type)} className="inline-block text-sm font-medium text-[var(--blue-text)] hover:underline">← 回到{landingLabel(currentUser?.org_type)}</Link>
    </div>
  )
}
...
const appRoutes = [
  ...
  { path: '/requirements/review', element: <RequirementsReview /> },

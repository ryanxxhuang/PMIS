...
> 更新:2026-07-09(全專案盤點見 docs/專案盤點-2026-07-09.md)。本文件是**唯一的現況/路線圖文件**;
> 功能與架構細節見 [README.md](README.md),長期產品願景(GC↔監造協作、Contract-First)見 [PRD.md](PRD.md)
> (部分內容屬早期 prototype 規劃,與現行程式不完全對應,見該文件開頭說明)。
>
